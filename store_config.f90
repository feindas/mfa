...
!    Open positions file
        ...
        open(12,file="film_xmol.xyz",status="unknown",position="append")
...
!
! #### conf_new ####
         open(unit=10,file="conf_new",status="unknown")
         write(10,'(i1)') 1
#ifdef STARS
...
#else
             write(11,203) "Cl   ",r0_unfold(:,i_part)
#endif
         end do
!    writes droplet/melt
#ifndef PARTICLE_4
...
#        else
            write(11,203) "He   ",r0_unfold(:,i_part)
#endif
         end do
#else         
...
#        else
             write(11,203) "N    ",r0_unfold(:,i_part)
#endif
         end do
#endif /*  particle 4 */        
...
!   
         case(3) ! store folded coordinates 
...
#if SYSTEM == 4
             if(i_part.eq.1) then 
                 write(12,203) "O   ",r0(1,i_part),r0(2,i_part),r0(3,i_part)     
             else
                 write(12,203) "Cl   ",r0(1,i_part),r0(2,i_part),r0(3,i_part)     
             end if
#else
             if(a_type(i_part).eq.1) write(12,203) "Cl   ",r0(1,i_part),r0(2,i_part),r0(3,i_part)      !ori
             if(a_type(i_part).eq.2) write(12,203) "O   ",r0(1,i_part), r0(2,i_part),r0(3,i_part)
!             if(a_type(i_part).eq.1) write(12,203) "Cl   ",r0(1,i_part),r0_unfold(2,i_part),r0_unfold(3,i_part)      !ori
...
#if SYSTEM == 4
            if(i_part.eq.1) then 
                write(12,203) "0   ",r0_unfold(1,i_part),r0_unfold(2,i_part),r0_unfold(3,i_part)
            else
                write(12,203) "Cl   ",r0_unfold(1,i_part),r0_unfold(2,i_part),r0_unfold(3,i_part)
            end if
         end do
#else
