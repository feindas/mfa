...
#       endif
#elif SYSTEM == 4
        print '(/a)', "  *  SIMULATING: polymeric chain with periodic countour conditions"
        print '(a/)', "  *  bulk geometry "
#	if RINGS == 1
        print '(a/)', "  *  Rings are thethered in the polimeric chain"
#	endif
#	if FIXCM == 1
        print '(a/)', "  *  CM chain is fixed"
#	endif
#endif
